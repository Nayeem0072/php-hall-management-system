...
<br><br>
      <div align="center">
      <p><?php if($row->approve) echo "<strong>This notice has been approved.</strong>" ?></p>
      ...
      <br><br><br>
      <a class="btn btn-theme btn-lg" <?php if($row->approve) echo "disabled"?> href="<?php echo base_url("index.php/approvenotice/approve?id=$noticeid"); ?>" role="button">Approve</a>
        </div>
