...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <p><?php 
      ...
      echo "<h5><strong>Publish Date &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;  </strong>".$row->complaindate."</h5><br>";
      echo "<h5><strong>Published By &nbsp; : &nbsp;&nbsp;&nbsp;  </strong>".$row->name."</h5><br>"; 
      echo "<h5><strong>Details &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;  </strong></h5><br><blockquote><p>".$row->complain."</blockquote>";
      
      if($user=="Staff")
        echo "<a class='btn btn-lg btn-info' href='". base_url("index.php/complainbox/review?id=$row->complainid") ."' role='button'>Review</a>"
