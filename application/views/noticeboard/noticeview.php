...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
        ...
        <div class="row mar-bot40">
          <div class="col-md-20 col-md-offset-0">
            ...
            <div class="align-left">
              ...
              <h3 class="slogan">Notice Board</h3>
              <p>
              Details of a Notice</p>
              <p><div align="right">
              <form class="navbar-form navbar-right" role="search" method = "post" action= "<?php echo base_url("index.php/noticeboard/search"); ?>">
        <div class="form-group">
          <input type="text"  class="form-control" name = "sub" placeholder="Search for Notices">
        </div>
      </form></div>
              </p>  
            </div>
    ...
    <p><?php 
      $row = $ndetail->row();
      echo "<h5><strong>Subject  &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    : &nbsp;&nbsp;&nbsp;  </strong>".$row->subject."</h5><br>";
      echo "<h5><strong>Publish Date &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;  </strong>".$row->publishdate."</h5><br>";
      echo "<h5><strong>Published By &nbsp; : &nbsp;&nbsp;&nbsp;  </strong>".$row->name."</h5>"; ?></p>
<br><br>
      <div align="center">
      <img src="<?php echo base_url("uploads/".$noticeid.".png"); ?>" class="img-rounded" alt="">  
      <img src="<?php echo base_url("uploads/".$noticeid.".jpg"); ?>" class="img-rounded" alt="">
      <br><br><br>
      <a class="btn btn-theme btn-lg" href="<?php echo base_url("index.php/noticeview/download?id=$noticeid"); ?>" role="button">Download</a>
      </div>
