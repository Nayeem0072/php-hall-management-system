...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
        ...
        <div class="row mar-bot40">
          <div class="col-md-20 col-md-offset-0">
            ...
            <div class="align-left">
              ...
              <p>Register a Student Account here
              </p>  
            </div>
          </div>
        </div>
    ...
    <div class="container">
    <form role="form" action='<?php echo base_url();?>index.php/register/insert' method='post'>
        <div class="form-group">
          <input type="name" class="form-control" placeholder="Name" name = "name" data-rule="required"><br>
          <input type="name" class="form-control" placeholder="Std Id." name = "id" data-rule="required"><br>
          ...
          <input type="name" class="form-control" name = "room" placeholder="Room No." ><br>
