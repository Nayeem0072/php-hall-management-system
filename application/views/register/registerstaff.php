...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
       ...
       <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
            ...
            <li class="active"><a href="<?php echo base_url("index.php/noticeboard/view"); ?>">Notice Board</a></li>
            <?php if($type=="Student")
        ...
        <div class="row mar-bot40">
          <div class="col-md-20 col-md-offset-0">
            ...
            <div class="align-left">
              ...
              <h3 class="slogan">Registration</h3>
              <p>Register a Staff Account here
              </p>  
            </div>
          </div>
        </div>
    ...
    <form role="form" action='<?php echo base_url();?>index.php/register/insertstaff' method='post'>
      <div class="form-group">
      <input type="text" class="form-control" name="name" placeholder="Name" data-rule="maxlen:4" data-msg="Please enter at least 4 chars" />
      <div class="validation"></div>
      <br>

      <input type="text" class="form-control" name="post" placeholder="Post" data-rule="maxlen:4" data-msg="Please enter at least 4 chars" />
      <div class="validation"></div>
      <br>
      ...
      <input type="text" class="form-control" name="username" placeholder="Username" data-rule="maxlen:4" data-msg="Please enter at least 4 chars" />
      <div class="validation"></div>
      <br>

      <input type="password" class="form-control" name="password" placeholder="Password" data-rule="maxlen:3" data-msg="Please enter at least 3 chars" />
      <div class="validation"></div>
...
<!-- 
    <form role="form" action='<?php //echo base_url();?>index.php/register/insertstaff' method='post'>
        <div class="form-group">
          <input type="name" class="form-control" placeholder="Name" name = "name" data-rule="required"><br>
          <input type="name" class="form-control" placeholder="Post" name = "post" data-rule="required"><br>
          <input type="date" class="form-control" name = "dob" placeholder="Date of Birth" ><br>
          <input type="name" class="form-control" name = "address" placeholder="Address" ><br>
          <input type="name" class="form-control" name = "phone" placeholder="Phone" ><br>
          <input type="name" class="form-control" name = "email" placeholder="E-mail" ><br>
          <input type="name" class="form-control" name = "username" placeholder="User name" data-rule="required"><br>
          <input type="password" class="form-control" name = "password" placeholder="Password" data-rule="required"><br>
