...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
       ...
       <div class="container">
        ...
        <div class="navbar-collapse collapse">
          ...
          ?>
            ...
            <?php if($type=="Student")
            echo "<li class='active'><a href='".base_url("index.php/submitcomplain/view")."'>Submit a Complain</a></li>";?>
    ...
    <div class="container">
    <form role="form" action='<?php echo base_url();?>index.php/submitcomplainstatus' method='post'>
        <div class="form-group">
          <input type="name" class="form-control" placeholder="Name" name = "name"><br>
    ...
    <textarea class="form-control" rows="4" name = "complain" placeholder="Write your complain here"></textarea><br>
  </div>
