...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
       ...
       <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
            ...
            <li class="active"><a href="<?php echo base_url("index.php/complainbox/view"); ?>">View Complains</a></li>
            <?php if($type=="Student")
        ...
        <div class="row mar-bot40">
          <div class="col-md-20 col-md-offset-0">
            ...
            <div class="align-left">
              ...
              <h3 class="slogan">Complain Box</h3>
              <p>
              <?php
        if($complainall == "no" && $type!= "Staff" && $type!="Provost"){
        echo ("<p class='lead'>Displaying all complains &nbsp;&nbsp;&nbsp; <a a class='btn btn-theme' href=".base_url("index.php/complainbox/viewall").">Show all your complains</a></li>
        </p>
     ");
      }
        else
          echo("<p class='lead'>Displaying all the complains");

      ?>
      <p><div align="right">
              <form class="navbar-form navbar-right" role="search" method = "post" action= "<?php echo base_url("index.php/complainbox/search"); ?>">
        <div class="form-group">
          <input type="text"  class="form-control" name = "sub" placeholder="Search for Complains">
        </div>
      </form></div>
    ...
    <div class="container">
     <table class="table table-striped">
            <thead>
            <?php
            if(!$complainbox) echo "You have no reviews left.";
            else{
              echo "<tr>
                <th>#</th>
                <th>Subject</th>
            ...
            <tbody>";
                $count = 1;
                // echo ("<td> $count </td>"); 
                // echo ("<td><a href='#'>$complainbox['subject']</a></td>");
                // echo ("<td> $complainbox['complaindate'] </td>");
                // echo ("<td>$complainbox['name']</td>");
                // echo ("<td>$complainbox['reviewedby']</td>");
            foreach ($complainbox->result() as $row)
            {
              echo "<tr>";
               echo ("<td> $count </td>");
               //echo ("<td> <a href='#'>$row->subject </a></td>");
               echo ("<td> <a href='". base_url("index.php/complainbox/showcomplain")."?id=".$row->complainid."'>$row->subject </a></td>");
