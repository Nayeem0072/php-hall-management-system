...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
        ...
        <div class="row mar-bot40">
          <div class="col-md-20 col-md-offset-0">
            ...
            <div class="align-left">
              ...
              <h3 class="slogan">Services</h3>
              <p>
              Displaying list of students asked for services. </p>
    ...
    <div class="col-md-10">
          <table class="table table-striped">
            ...
            <?php
            if($mednil){
              echo "<h4>No Students Asked for Medical Help</h4><br>";
            }
            if($getmed && !$mednil){
              echo "<h4> List of Students Asked for Medical Help </h4><br>";
              echo "<tr>
                <th>#</th>
                <th>Name</th>
                <th>Room</th>
        ...
        <div class="col-md-10">
          <table class="table table-striped">
            ...
            <?php
            if($launil){
              echo "<h4>No Students Asked for Laundry Service</h4><br>";
            }
            if($getlau && !$launil){
              echo "<h4><br><br><br><br> List of Students Asked for Laundry Service </h4><br>";
              echo "<tr>
                <th>#</th>
                <th>Name</th>
                <th>Room</th>
...
<br><br><br>
        ...
        <div align = "center">
    <br><br><br>
    <a class="btn btn-theme" <?php if($mednil && $launil) echo "disabled"; ?> href="<?php echo base_url("index.php/serviceview/clear"); ?>" role="button">Clear All</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

      <a class="btn btn-theme" <?php if($mednil && $launil) echo "disabled"; ?> href="<?php echo base_url("index.php/serviceview/download"); ?>" role="button">Download PDF</a>
      </div>
